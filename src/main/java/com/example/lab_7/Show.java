...
public class Show {
    ...
    public void showHouseList(ArrayList<House> flats, ListView list_view){
        list_view.getItems().clear();
        for(House flat:flats)
        list_view.getItems().add(flat);
    }
    ...
    public void showFloorNumberList(TreeMap<Integer, ArrayList<Integer>> map, ListView list_view){
        list_view.getItems().clear();
